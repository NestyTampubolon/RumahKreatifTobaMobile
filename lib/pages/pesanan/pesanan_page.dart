...
class _PesananPageState extends State<PesananPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: _userLoggedIn ? RefreshIndicator(
        child: Column(
          children: [
            Container(
              ...
              child: Column(
                children: [
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              border: Border.all(color: filter?.name == selectedValue?.name ? Colors.green : AppColors.buttonBackgroundColor),
                              borderRadius: BorderRadius.circular(Dimensions.radius20 / 2),
                              color: filter?.name == selectedValue?.name ? AppColors.notification_success.withOpacity(0.3) : Colors.white,
                            ),
                            child: Row(
                              ...
                              children: [
                                SmallText(
                                  ...
                                  color: filter?.name == selectedValue?.name ? AppColors.notification_success : Colors.grey,
                                ),
                              ],
                            ),
                          ),
                  ...
                  GetBuilder<PesananController>(builder: (pesananController) {
                    return selectedValue?.name == "Semua" ? GridView.builder(
                                ...
                                Container(
                                  child: Row(
                                    ...
                                    children: [
                                          ...
                                          children: [
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                SmallText(
                                                    text: pesananController.pesananList[index].name
                                                        .toString()),
                                                Container(
                                                    ...
                                                    child: Center(
                                                      child: BigText(
                                                          text: pesananController.pesananList[index].statusPembelian
                                                              .toString(),
                                      ...
                                      Container(
                                        child: SmallText(
                                          text: pesananController.pesananList[index].createdAt
                                              .toString() ?? 'N/A',
                                        ...
                                        child: Row(
                                          children: [
                                            GestureDetector(
                                              onTap: () {
                                                var produkIndex =
                                                pesananController.pesananList[index]
                                                    .productId!;
                                                if (produkIndex >= 0) {
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: BigText(
                                                    text: pesananController.pesananList[index]
                                                        .productName,
                                                    size: Dimensions.font16,
                                                  ),
                                                ),
                                ...
                                Container(
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          _getDetailPesananList(pesananController.pesananList[index].purchaseId);
                                        },
                                        child: Container(
                                          padding: EdgeInsets.only(
                                              top: Dimensions.height10 / 2,
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    fit: BoxFit.fill,
                                    image: AssetImage(
                                        "assets/images/pemesanan_kosong.jpg"))),
                          ),
                          BigText(text: "Pesanan Kosong! Ayo berbelanja sekarang")
                        ],
                      ),
                    )),],
            ),
