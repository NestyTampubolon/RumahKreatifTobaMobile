  ...
  Future<void> _search(String keyword) async {
    ...
    if (keyword.isEmpty) {
      ...
      if (widget.kategori == "All") {
        results = Get.find<PopularProdukController>()
            .popularProdukList
            .where((produk) => produk.productName
                .toLowerCase()
        ...
        results = Get.find<PopularProdukController>()
            ...
            .where((produk) => produk.productName
                ...
                .contains(keyword.toLowerCase()))
            .where(
                (produk) => produk.namaKategori.toString() == widget.kategori)
            .toList();
      }
    }
      ...
      GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return CardProduk(
                ...
                countPurchases: _list[index].countProductPurchases);
          })
    ])));
    ;
  }
